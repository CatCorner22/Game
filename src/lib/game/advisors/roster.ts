...
const R: Record<PlayableId, Advisor[]> = {
  US: [
    ...
    },
    {
      id: "US:nsa",
      seat: "US",
      name: "Miriam Delacroix",
      rank: "Assistant to the President",
      ...
      institutional: 30,
      rung: 3,
      voice: "Runs the process, and says out loud when the process has been skipped rather than after.",
    },
    {
      id: "US:dcia",
      seat: "US",
      ...
      institutional: 72,
      rung: 3,
      voice: "Separates what a source said from what the source could actually have known, every time.",
    },
  ],
  ...
  RU: [
    ...
    { id: "RU:mfa", seat: "RU", name: "Minister Galina Rozhkova", rank: "Foreign Minister", role: "Foreign Minister", branch: "diplomatic", age: 59, hawkBase: 26, candor: 68, institutional: 60, rung: 3, voice: "Thinks about what the other capital believes right now, not what is true." },
    {
      ...
      institutional: 80,
      rung: 3,
      voice: "Convenes the room and decides what reaches the President. That second power is the larger one.",
    },
    {
      id: "RU:fsb",
      seat: "RU",
      name: "Yelena Barsukova",
      rank: "Director",
      role: "Federal security service director",
      branch: "intel",
      age: 57,
      hawkBase: 62,
      candor: 44,
      institutional: 85,
      rung: 3,
      voice: "Treats an internal explanation as the likeliest one until an external explanation is proven.",
    },
  ],
  ...
  CN: [
    ...
    { id: "CN:mfa", seat: "CN", name: "Minister Han Xiuying", rank: "Foreign Minister", role: "Foreign Minister", branch: "diplomatic", age: 60, hawkBase: 24, candor: 66, institutional: 62, rung: 3, voice: "Guards the no-first-use position as a strategic asset, not a slogan." },
    {
      ...
      institutional: 86,
      rung: 3,
      voice: "Reports what the leadership needs to act on and holds back what would only alarm it.",
    },
  ],
  ...
  UK: [
    ...
    { id: "UK:fco", seat: "UK", name: "Foreign Secretary Hugh Amarant", rank: "Foreign Secretary", role: "Foreign Secretary", branch: "diplomatic", age: 58, hawkBase: 22, candor: 72, institutional: 60, rung: 3, voice: "Thinks in alliances. Will ask what Washington and Paris are seeing before anything else." },
    {
      id: "UK:nsadv",
      seat: "UK",
      name: "Sir Callum Aitchison",
      rank: "National Security Adviser",
      ...
      institutional: 50,
      rung: 3,
      voice: "Keeps the committee to the question in front of it and writes down who advised what.",
    },
    {
      id: "UK:sis",
      seat: "UK",
      name: "Rowena Blackwood",
      rank: "Chief",
      role: "Chief of the Secret Intelligence Service",
      branch: "intel",
      age: 55,
      hawkBase: 45,
      candor: 72,
      institutional: 70,
      rung: 3,
      voice: "Will say when a judgement rests on one source, and will not say who the source is.",
    },
  ],
  ...
  FR: [
    ...
    { id: "FR:armees", seat: "FR", name: "Ministre Isabelle Fournier", rank: "Minister for the Armed Forces", role: "Minister for the Armed Forces", branch: "civilian", age: 55, hawkBase: 42, candor: 72, institutional: 66, rung: 3, voice: "Reminds the room that the decision is the President's alone, and means it as a caution." },
    {
      ...
      role: "Secretary-General for National Defence and Security",
      branch: "civilian",
      age: 56,
      hawkBase: 42,
      candor: 76,
      institutional: 58,
      rung: 3,
      voice: "Owns the continuity plan and will not let a decision be taken that the plan cannot survive.",
    },
    {
      id: "FR:mfa",
      seat: "FR",
      name: "Minister Olivier Sabatier",
      rank: "Minister",
      ...
      institutional: 54,
      rung: 3,
      voice: "Asks who else has to agree before this works, and points out when the answer is nobody.",
    },
  ],
  ...
  IN: [
    ...
    { id: "IN:nsa", seat: "IN", name: "National Security Adviser Latika Varma", rank: "National Security Adviser", role: "National Security Adviser", branch: "civilian", age: 63, hawkBase: 44, candor: 78, institutional: 62, rung: 3, voice: "Runs the room. Will state the political consequence before the military one." },
    {
      ...
      institutional: 56,
      rung: 3,
      voice: "Counts which capitals will still take the call afterwards, and treats that as a capability.",
    },
    {
      id: "IN:defmin",
      seat: "IN",
      name: "Minister Rajat Kulkarni",
      rank: "Minister",
      ...
      institutional: 48,
      rung: 3,
      voice: "Reads the domestic clock out loud, because nobody else in the room is willing to.",
    },
  ],
  ...
  PK: [
    ...
    { id: "PK:nca", seat: "PK", name: "Foreign Minister Rukhsana Malik", rank: "Foreign Minister", role: "Foreign Minister, National Command Authority", branch: "diplomatic", age: 57, hawkBase: 30, candor: 72, institutional: 60, rung: 3, voice: "The DGMO hotline is her first instrument and she reaches for it early." },
    {
      id: "PK:cjcsc",
      seat: "PK",
      name: "General Tariq Suleiman",
      rank: "General",
      role: "Chairman, Joint Chiefs of Staff Committee",
      branch: "ground",
      age: 60,
      hawkBase: 64,
      candor: 54,
      institutional: 82,
      rung: 3,
      voice: "Speaks for the services as one voice, which is not the same as the services agreeing.",
    },
    {
      id: "PK:nsa",
      seat: "PK",
      ...
      rank: "Adviser",
      role: "National security adviser to the Prime Minister",
      branch: "civilian",
      age: 53,
      hawkBase: 44,
      candor: 68,
      institutional: 38,
      rung: 3,
      voice: "The only person here whose authority comes from the civilian side, and is aware of it.",
    },
  ],
  ...
  IL: [
    ...
    { id: "IL:mod", seat: "IL", name: "Minister Tamar Golani", rank: "Minister of Defense", role: "Minister of Defense", branch: "civilian", age: 60, hawkBase: 54, candor: 72, institutional: 68, rung: 3, voice: "Weighs opacity against the value of saying something out loud, and usually keeps quiet." },
    {
      ...
      name: "Yael Ben-Tzur",
      rank: "Head",
      role: "Head of the National Security Council",
      branch: "civilian",
      age: 54,
      hawkBase: 50,
      candor: 74,
      institutional: 44,
      rung: 3,
      voice: "Insists the cabinet name the objective before it approves the operation, and is often ignored.",
    },
    {
      id: "IL:mossad",
      seat: "IL",
      ...
      institutional: 76,
      rung: 3,
      voice: "Offers what can be done quietly, and is careful never to promise what it would achieve.",
    },
    {
      id: "IL:mfa",
      seat: "IL",
      name: "Minister Dafna Erez",
      rank: "Minister",
      ...
      institutional: 50,
      rung: 3,
      voice: "Tracks which friendly governments could survive defending this, and says when the list is empty.",
    },
  ],
  ...
  KP: [
    ...
    { id: "KP:party", seat: "KP", name: "Secretary O Kwang-chol", rank: "Party Secretary", role: "Party secretary for defence industry", branch: "civilian", age: 61, hawkBase: 60, candor: 34, institutional: 78, rung: 3, voice: "Speaks in loyalty and legacy. Never contradicts." },
    {
      ...
      institutional: 74,
      rung: 3,
      voice: "Frames every concession as a demand and every demand as a concession already granted.",
    },
    {
      id: "KP:gpb",
      seat: "KP",
      name: "Director Pak Song-hui",
      rank: "Director",
      role: "Director, General Political Bureau",
      branch: "civilian",
      age: 59,
      hawkBase: 60,
      candor: 22,
      institutional: 90,
      rung: 3,
      voice: "Watches the room rather than the map, and reports on it afterwards.",
    },
  ],
  ...
  IR: [
    ...
    { id: "IR:council", seat: "IR", name: "Secretary Javad Amini", rank: "Secretary", role: "Supreme National Security Council secretary", branch: "civilian", age: 64, hawkBase: 44, candor: 60, institutional: 70, rung: 3, voice: "Manages the Council's consensus and the Leader's deniability at the same time." },
    {
      ...
      institutional: 52,
      rung: 3,
      voice: "Argues that the channel is worth more than the leverage, and loses that argument regularly.",
    },
    {
      id: "IR:rep",
      seat: "IR",
      name: "Hojjat Kariminejad",
      rank: "Representative",
      role: "Representative of the Supreme Leader to the Council",
      branch: "civilian",
      age: 64,
      hawkBase: 58,
      candor: 36,
      institutional: 92,
      rung: 3,
      voice: "Does not chair this council and outranks the man who does. Everyone here knows it.",
    },
  ],

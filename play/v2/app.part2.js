    function load(){ try{return JSON.parse(localStorage.getItem('threshold.portable.v1')||'null');}catch{return null;} }
    function clearSave(){ try{localStorage.removeItem('threshold.portable.v1');}catch{} }
